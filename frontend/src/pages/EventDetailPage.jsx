...
export default function EventDetailPage() {
    ...
    const availablePlaces = event.participant_limit === null
      ? null
      ...
      <>
        ...
        <div className="event-detail-layout">
          ...
          <aside className="event-registration-card">
            ...
            <div className="registration-summary">
              {event.participant_limit === null ? (
                ...
                <>
                  ...
                  <span>
                    {acceptedApplicationsCount} z {event.participant_limit} osób zgłoszonych
                  </span>
                </>
              )}
            ...
            <button className="button button-primary registration-button" type="button">
